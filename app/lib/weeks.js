...
class Weeks {
  ...
  leaveAndPay() {
    ...
    let secondarySplHasStarted = false;
      ...
      if (!week.secondary.disabled) {
        ...
        if (weekLeaveAndPay.secondary.leave) {
          ...
          if (
            ...
            !secondarySplHasStarted
          ) {
            dset(week.secondary, "leave.text", "paternity");
          } else {
            dset(week.secondary, "leave.text", "shared");
            dset(week.primary, "leave.text", "shared");
            // set secondarySplHasStarted to true if the secondary parent has used all paternity leave weeks
            secondarySplHasStarted =
              secondaryLeaveTracker.totalLeaveWeeks >=
              maxCellsDisplayedAsPaternity;
          }
