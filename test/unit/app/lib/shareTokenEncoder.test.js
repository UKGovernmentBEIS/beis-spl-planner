...
const ShareTokenEncoder = require('../../../../app/lib/shareToken/shareTokenEncoder')
...
describe('shareTokenEncoder', () => {
  ...
  describe('#encode, version 1', () => {
    ...
    it('encodes eligibility', () => {
      ...
      const shareTokenEncoder = new ShareTokenEncoder(data)
      const expected =
        '0!kFx!Yhkn!0!0!0!0000000000000000000000000000000000000000000'
    ...
    it('encodes the start date', () => {
      ...
      const shareTokenEncoder = new ShareTokenEncoder(data)
      const expected =
        '0!000!Yhkn!0!0!0!0000000000000000000000000000000000000000000'
    ...
    it('encodes salary information', () => {
      ...
      const shareTokenEncoder = new ShareTokenEncoder(data)
      const expected =
        '0!000!Yhkn!18co!171_!E!0000000000000000000000000000000000000000000'
